...
//        //2nd methode
//
//        // Create a collection for experiences based on userId
//        MongoCollection<Document> experienceCollection = database.getCollection("experiences");
//
//        // Create documents for each experience and insert into the collection
//        for (Experience experience : experiences) {
//            Document experienceDocument = experience.toDocument();
//            experienceDocument.append("userId", userId);  // Add userId to the document
//            experienceCollection.insertOne(experienceDocument);
//        }
    }
}
